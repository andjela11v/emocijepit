...
DROP DATABASE IF EXISTS `db_emocije_m`;
CREATE DATABASE IF NOT EXISTS `db_emocije_m` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `db_emocije_m`;

-- Dumping structure for table db_emocije_m.emocije
